...
<body>
	...
	<div class="row">
		<div class="col-sm-3 margin text-left" style="border-right:groove;border-color:lightgray;"><h4 class="margin text-center">Child's Data</h4>
            <asp:Panel ID="Panel1" runat="server">
                ...
                <cc1:MaskedEditExtender ID="MaskedEditExtender1" runat="server" TargetControlID="TxtDate" Mask="99/99/9999" MaskType="Date"></cc1:MaskedEditExtender>
                ...
                <asp:CompareValidator ID="CompareDOV" runat="server" ControlToValidate="TxtDate" Operator="LessThan" Type="Date" ErrorMessage="*Invalid Date"  Font-Size="Smaller" ForeColor="Red"></asp:CompareValidator>
		...
		<div id="child" class="col-sm-9" runat="server"><h3 class="margin">Vaccines Administered</h3>
			...
			<div id="birth" class="col-sm-2" style="border-right:groove;border-color:lightgray;" runat="server"><h4 class="margin"><strong>At Birth</strong></h4>	
                <asp:CheckBox runat="server" ID="CheckBCG" class="tab"/><label>BCG</label></br></br>
            ...
            <div id="remarks" class="col-sm-2" runat="server"><h4 class="margin"><strong>Remarks</strong></h4>
				<asp:TextBox ID="TextBox1" runat="server" class="form-control" size="15"></asp:TextBox>
			</div>
	    </div>
     ...
     <div id="mother" class="col-sm-9" style="margin-top:10px;" runat="server" visible="False"><h3 style="margin-bottom:30px;">Mother Vaccines</h3>
         ...
         <div id="Div1" class="col-sm-2" runat="server"><asp:TextBox ID="TextBox2" runat="server" class="form-control" size="15"></asp:TextBox></div>
	</div>
