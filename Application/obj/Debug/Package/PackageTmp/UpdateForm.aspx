...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function CalculateAge() {
            ...
            document.getElementById("AgeMonths").value = monleft + " m";
            document.getElementById("AgeDays").value = dife[2] + " d";
                ...
                <div id="Div1" runat="server" class="col-sm-7">
                    ...
                    <div id="child" runat="server">
                        ...
                        <div id="birth" class="col-sm-2" style="border-right: groove; border-color: lightgray;" runat="server">
                            ...
                            <cc1:MaskedEditExtender ID="MaskedEditExtender3" runat="server" TargetControlID="txtDateV1" Mask="99/99/9999" MaskType="Date"></cc1:MaskedEditExtender>
                            <br />
                            <br />
                        ...
                        <div id="week6" class="col-sm-2" style="border-right: groove; border-color: lightgray;" runat="server">
                            ...
                            <cc1:MaskedEditExtender ID="MaskedEditExtender4" runat="server" TargetControlID="txtDateV2" Mask="99/99/9999" MaskType="Date"></cc1:MaskedEditExtender>
                            <br />
                            <br />
                        ...
                        <div id="week10" class="col-sm-2" style="border-right: groove; border-color: lightgray;" runat="server">
                            ...
                            <cc1:MaskedEditExtender ID="MaskedEditExtender5" runat="server" TargetControlID="txtDateV3" Mask="99/99/9999" MaskType="Date"></cc1:MaskedEditExtender>
                            <br />
                            <br />
                        ...
                        <div id="week14" class="col-sm-2" style="border-right: groove; border-color: lightgray;" runat="server">
                            ...
                            <cc1:MaskedEditExtender ID="MaskedEditExtender6" runat="server" TargetControlID="txtDateV4" Mask="99/99/9999" MaskType="Date"></cc1:MaskedEditExtender>
                            <br />
                            <br />
                        ...
                        <div id="months9" class="col-sm-2" style="border-right: groove; border-color: lightgray;" runat="server">
                            ...
                            <cc1:MaskedEditExtender ID="MaskedEditExtender7" runat="server" TargetControlID="txtDateV5" Mask="99/99/9999" MaskType="Date"></cc1:MaskedEditExtender>
                            <br />
                            <br />
                        ...
                        <div id="months15" class="col-sm-2" style="border-right: groove; border-color: lightgray;" runat="server">
                            ...
                            <cc1:MaskedEditExtender ID="MaskedEditExtender8" runat="server" TargetControlID="txtDateV6" Mask="99/99/9999" MaskType="Date"></cc1:MaskedEditExtender>
                            <br />
                            <br />
                    ...
                    <div id="mother" runat="server" style="margin-top: 350px;">
                        ...
                        <div class="col-sm-2" style="border-right: groove; border-color: lightgray;">
                            ...
                            <cc1:MaskedEditExtender ID="MaskedEditExtender9" runat="server" TargetControlID="txtDateMV1" Mask="99/99/9999" MaskType="Date"></cc1:MaskedEditExtender>
                            <br />
                            <br />
                        ...
                        <div class="col-sm-2" style="border-right: groove; border-color: lightgray;">
                            ...
                            <cc1:MaskedEditExtender ID="MaskedEditExtender10" runat="server" TargetControlID="txtDateMV2" Mask="99/99/9999" MaskType="Date"></cc1:MaskedEditExtender>
                            <br />
                            <br />
                        ...
                        <div class="col-sm-2" style="border-right: groove; border-color: lightgray;">
                            ...
                            <cc1:MaskedEditExtender ID="MaskedEditExtender11" runat="server" TargetControlID="txtDateMV3" Mask="99/99/9999" MaskType="Date"></cc1:MaskedEditExtender>
                            <br />
                            <br />
                        ...
                        <div class="col-sm-2" style="border-right: groove; border-color: lightgray;">
                            ...
                            <cc1:MaskedEditExtender ID="MaskedEditExtender12" runat="server" TargetControlID="txtDateMV4" Mask="99/99/9999" MaskType="Date"></cc1:MaskedEditExtender>
                            <br />
                            <br />
