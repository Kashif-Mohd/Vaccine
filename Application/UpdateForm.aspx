	...
	<div class="row">
		<div class="col-sm-3 margin text-left" style="top: 0px; left: 0px; border-right-style: groove; border-right-color: inherit; border-right-width: medium;"><h4 class="margin text-center">Child's Data</h4>
            ...
            <asp:Panel ID="Panel8" runat="server" ClientIDMode="Static">
                <label style="font-size: small">Child Age</label><asp:TextBox ID="TextCAge" runat="server" class="form-control align" onkeyup="" placeholder="(in months)" ClientIDMode="Static"></asp:TextBox>
            </asp:Panel><br /><br />
		...
		<div id="child" runat="server"><h3 class="margin">Vaccines Administered</h3>
        ...
        <hr />
         <div id="mother" runat="server" style="margin-top:10px;" visible="False"><h3 style="margin-bottom:30px;">Mother Vaccines</h3>
        ...
        <div id="remarks" class="col-sm-2" runat="server" style="margin-top:5%;"><h4 class="margin"><strong>Remarks</strong></h4>
		    <asp:TextBox ID="txtremarks" runat="server" class="form-control" size="15"></asp:TextBox>
	    </div>
        
    <asp:Button id="Btnsbmt" runat="server" Text="Update" onclick="Button1_Click"  CssClass="btn" style="width: 20%;margin-top:30px;" />
   </div>
</div>
